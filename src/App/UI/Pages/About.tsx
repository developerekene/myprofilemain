              ...
              <div className={styles.mainContent}>
                ...
                <section id="experience" className={styles.section}>
                  <div className={styles.sectionContent}>
                        ...
                        <div className={styles.experienceHeader}>
                          ...
                          <div className={styles.experienceDetails}>
                            ...
                            <p className={styles.experienceDescription}>
                              ...
                              design systems, mobile apps, and digital
                              experiences for a diverse array of projects for
                              clients including Harvard Business School,
                              Everytown for Gun Safety, Pratt Institute, Koala
                              Health, Vanderbilt University, The 19th News, and
                              more. Provide leadership within engineering
                    ...
                    <div className={styles.resumeLink}>
                      <a href="/resume.pdf" className={styles.resumeLinkText}>
                        View Full Résumé
                        <svg
                          className={styles.externalIcon}
                          width="16"
                ...
                <section id="projects" className={styles.section}>
                  <div className={styles.sectionContent}>
                    ...
                    <p className={styles.paragraph}>
                      Coming soon - A showcase of selected projects and work
                      samples.
                    </p>
                  </div>
                </section>
